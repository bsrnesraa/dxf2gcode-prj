...
from source.core.layercontent import LayerContent, Layers, Shapes
from source.core.entitycontent import EntityContent
from source.core.customgcode import CustomGCode
from source.core.linegeo import LineGeo
from source.core.holegeo import HoleGeo
from source.core.project import Project
from source.globals.config import MyConfig
import source.globals.globals as g
from source.globals.logger import LoggerClass

from source.gui.configwindow import ConfigWindow
from source.gui.treehandling import TreeHandler
from source.gui.popupdialog import PopUpDialog
from source.gui.aboutdialog import AboutDialog

from source.dxfimport.importer import ReadDXF

from source.postpro.postprocessor import MyPostProcessor
from source.postpro.tspoptimisation import TspOptimization

from source.globals.helperfunctions import str_encode, str_decode, qstr_encode

from source.globals.six import text_type
...
if __name__ == "__main__":
    ...
    if c.PYQT5notPYQT4:
        from source.dxf2gcode_ui5 import Ui_MainWindow
    else:
        from dxf2gcode_ui4 import Ui_MainWindow
    if g.config.mode3d:
        from source.core.shape import Shape
        # multi-sampling has been introduced in PyQt5
        fmt = QSurfaceFormat()
        fmt.setSamples(4)
        QSurfaceFormat.setDefaultFormat(fmt)
    else:
        from source.gui.canvas2d import MyGraphicsScene
        from source.gui.canvas2d import ShapeGUI as Shape
